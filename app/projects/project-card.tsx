...
export default function ProjectCard({ item }: ItemProps) {
  return (
    <Link className="rounded-lg border border-slate-200 hover:border-slate-300 dark:border-slate-800 dark:hover:border-slate-700 transition-color ease-in-out p-5 group" href={item.slug}>
