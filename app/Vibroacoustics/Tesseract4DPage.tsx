...
const TESSERACT_VERTEX_COUNT = 16;
const PROJECTION_DISTANCE = 3;

/* ------------------------------------------------------------------ */
/*  Tesseract4DPage Component                                          */
/* ------------------------------------------------------------------ */
export default function Tesseract4DPage() {
  ...
  useEffect(() => {
    ...
    const animate = (): void => {
      ...
      const projected = rotatedVertices.map((v) => project4Dto3(v, PROJECTION_DISTANCE));
