...
// Marvel API keys and endpoint for comics
 ...
 *
 * Provides a search form for Marvel comics and displays the search results.
 */
const MarvelComicsPage = () => {
  ...
  return (
    <div className="p-4 dark:text-gray-100">
      ...
      <form onSubmit={handleComicSearch} className="flex flex-col sm:flex-row gap-2 mb-4">
        <input
          type="text"
          value={comicQuery}
      ...
      {loadingComics ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {comicResults.map((comic) => (
            <div key={comic.id} className="border border-gray-300 rounded p-4 dark:border-gray-700">
              <img
