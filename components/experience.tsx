    ...
    <div className="space-y-8">
      ...
      <ul className="space-y-8">
        ...
        <li className="relative group">
          <div className="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-white before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8 before:group-last-of-type:hidden">
            <div className="absolute left-0 h-14 w-14 flex items-center justify-center border border-slate-200 dark:border-slate-800 bg-white rounded-full">
              <Image className="object-contain" src={DCI} alt="Data Center Inc. Logo" width={46} height={46} />
            </div>
            <div className="pl-20 space-y-2">
              <div className="text-xs text-slate-500 uppercase tracking-wide">
                April 2025 <span className="text-slate-400 dark:text-slate-600">·</span> Present
              </div>
              <div className="font-aspekta font-[650] text-slate-800 dark:text-slate-100">Senior Engineer Level II</div>
              <div className="text-sm font-medium text-indigo-500 dark:text-indigo-400">Data Center Inc. — Remote</div>
              ...
              <TagList tags={['C#', '.NET Framework', '.NET Core', 'SQL Server', 'ASP.NET MVC', 'ASP.NET WebForms', 'Stored Procedures', 'ACH Processing', 'Batch Systems', 'Reconciliation Pipelines', 'Transaction Flows', 'Reporting Layers', 'REST APIs', 'Telerik', 'Windows Server', 'SCA / Code Analysis', 'Agile']} />
            </div>
          </div>
        </li>
        ...
        <li className="relative group">
          <div className="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-white before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8 before:group-last-of-type:hidden">
            <div className="absolute left-0 h-14 w-14 flex items-center justify-center border border-slate-200 dark:border-slate-800 bg-white rounded-full">
              <Image className="object-contain" src={ApplyPro} alt="ApplyPro Logo" width={46} height={46} />
            </div>
            <div className="pl-20 space-y-2">
              <div className="text-xs text-slate-500 uppercase tracking-wide">
                September 2024 <span className="text-slate-400 dark:text-slate-600">·</span> Present
              </div>
              <div className="font-aspekta font-[650] text-slate-800 dark:text-slate-100">Founder &amp; Lead Engineer</div>
              <div className="text-sm font-medium text-indigo-500 dark:text-indigo-400">ApplyPro.ai — Boulder, CO</div>
              <div className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              <TagList tags={['Next.js', 'App Router', 'SSR', 'React', 'TypeScript', 'Node.js', 'PostgreSQL', 'REST APIs', 'AI Integration', 'Document Processing', 'Stripe', 'Subscription Billing', 'Mixpanel', 'Tailwind CSS', 'Component Architecture', 'Vercel', 'CI/CD']} />
            </div>
          </div>
        </li>
        ...
        <li className="relative group">
          <div className="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-white before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8 before:group-last-of-type:hidden">
            <div className="absolute left-0 h-14 w-14 flex items-center justify-center border border-slate-200 dark:border-slate-800 bg-white rounded-full">
              <Image className="object-contain" src={UMail} alt="UMail Logo" width={46} height={46} />
            </div>
            <div className="pl-20 space-y-2">
              <div className="text-xs text-slate-500 uppercase tracking-wide">
              ...
              <div className="font-aspekta font-[650] text-slate-800 dark:text-slate-100">Founder &amp; Lead Engineer</div>
              <div className="text-sm font-medium text-indigo-500 dark:text-indigo-400">U-Mail.ai — Boulder, CO</div>
              <div className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              <TagList tags={['Node.js', 'Express', 'React', 'Firebase Auth', 'Realtime DB', 'OAuth 2.0', 'Gmail API', 'OpenAI API', 'Voice-to-Text', 'AI Text Enhancement', 'Google Meet API', 'Zoom API', 'Multi-Tenant Architecture', 'REST APIs', 'GCP', 'Vercel', 'Mixpanel', 'B2B SaaS']} />
            </div>
          </div>
        </li>
        ...
        <li className="relative group">
          <div className="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-white before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8 before:group-last-of-type:hidden">
            <div className="absolute left-0 h-14 w-14 flex items-center justify-center border border-slate-200 dark:border-slate-800 bg-white rounded-full">
              <Image className="object-contain" src={spgi} alt="S&P Global Logo" width={47} height={47} />
            </div>
            <div className="pl-20 space-y-2">
              <div className="text-xs text-slate-500 uppercase tracking-wide">
              ...
              <div className="text-sm font-medium text-indigo-500 dark:text-indigo-400">
                S&amp;P Global — Boulder, CO <span className="text-slate-400 dark:text-slate-600">·</span> <span className="italic">10 Years Total</span>
              </div>
              <div className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              <TagList tags={['React', 'Vue.js', 'JavaScript', 'C#', '.NET', 'ASP.NET', 'Razor', 'Node.js', 'Express', 'SAML', 'SSO', 'OAuth 2.0', 'SQL Server', 'REST APIs', 'Data Ingestion Pipelines', 'Exchange Vendor Feeds', 'Real-Time Financial Data', 'Distributed Systems', 'Enterprise Architecture', 'Performance Optimization', 'SLA Compliance']} />
            </div>
          </div>
        </li>
        ...
        <li className="relative group">
          <div className="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-white before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8 before:group-last-of-type:hidden">
            ...
            <div className="pl-20 space-y-2">
              ...
              <div className="text-sm font-medium text-indigo-500 dark:text-indigo-400">S&amp;P Global — Boulder, CO</div>
              <div className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              <TagList tags={['JavaScript', 'HTML/CSS', 'Real-Time Data', 'Live Streaming', 'Financial Web Apps', 'Enterprise Systems', 'Legacy Codebases', 'Client Integration', 'Global Markets', 'Production Support']} />
            </div>
          </div>
        </li>
        ...
        <li className="relative group">
          <div className="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-white before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8">
            ...
            <div className="pl-20 space-y-2">
              ...
              <TagList tags={['JavaScript', 'HTML/CSS', 'Financial Web Apps', 'Enterprise Platforms', 'Legacy Systems', 'Agile', 'Performance Optimization', 'Client Projects', 'Cross-Team Collaboration']} />
            </div>
          </div>
        </li>
