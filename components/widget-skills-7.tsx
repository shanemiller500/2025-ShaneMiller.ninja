    ...
    <div className="rounded-lg border border-slate-200 dark:border-slate-800  odd:-rotate-1 even:rotate-1 hover:rotate-0 transition-transform duration-700 hover:duration-100 ease-in-out p-5">
      ...
      <ul className="space-y-3">
        ...
        <li className="flex justify-between items-center">
          ...
          <div
            className="shrink-0 relative w-20 h-1.5 bg-slate-200 dark:bg-slate-700 before:absolute before:inset-0 before:bg-indigo-500 before:w-[75%]"
            role="progressbar"
            aria-valuenow={100}
            aria-valuemin={0}
            aria-valuemax={100}
        ...
        <li className="flex justify-between items-center">
          ...
          <div
            className="shrink-0 relative w-20 h-1.5 bg-slate-200 dark:bg-slate-700 before:absolute before:inset-0 before:bg-indigo-500 before:w-[70%]"
            role="progressbar"
            aria-valuenow={100}
            aria-valuemin={0}
            aria-valuemax={100}
